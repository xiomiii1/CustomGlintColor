...
target("CustomGlintColor")
    ...
    add_files(
        ...
        "src/modules/visual/glintcolor.cpp"
    )
    ...
    after_build(function (target)
        ...
        assert(python, "Python 3 is required to package CustomGlintColor.levipack")
        ...
        table.insert(args, path.join(os.projectdir(), "icon.png"))
        table.insert(args, "--version-header")
        table.insert(args, path.join(os.projectdir(), "include", "glintmod", "Version.hpp"))
        table.insert(args, "--output")
        table.insert(args, path.join(target:targetdir(), "CustomGlintColor.levipack"))
